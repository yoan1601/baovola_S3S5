...
<body>
    <form style="max-width: 700px;margin: 70px;margin-left: 112px;" role="form" action="indexTeachers.html" method="post" enctype="multipart/form-data">
        <div class="form-group mb-3" style="font-size: 36px;text-align: center;color: rgb(177,28,19);"><label class="form-label" style="font-family: 'Abril Fatface', serif;font-weight: bold;text-decoration:  underline;"><span style="color: rgb(48, 47, 47);">Affection d'une unite a une matiere</span></label></div>
        <div class="form-group mb-3"><label class="form-label" style="border-color: rgb(242,7,7);">Matiere:&nbsp;</label><select class="form-select" id="tomSelect2" required="" name="Matiere" style="background: rgb(108,108,108);">
                <option value="1">cuire</option>
                <option value="2">raphia</option>
            </select></div>
        <div class="form-group mb-3"><label class="form-label">Unite:&nbsp;</label><select class="form-select" id="tomSelect-1" required="" name="unite" style="background: rgb(116,116,116);">
                <option value="1">metre</option>
                <option value="2">metre carree</option>
            </select></div>

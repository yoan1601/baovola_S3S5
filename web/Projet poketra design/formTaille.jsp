        ...
        <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
            <div class="card mb-5">
                <div class="card-body p-sm-5">
                    <h2 class="text-center mb-4">Creation d'une taille</h2><label class="form-label"><span style="color: rgb(3, 114, 225);">Nom du taille:&nbsp;</span></label><input type="text" style="width: 205px;">
                    <form method="post">
                        <div class="mb-3"></div>
                        <div class="mb-3"></div>
                        <div class="mb-3"></div>

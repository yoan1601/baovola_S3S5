        ...
        <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
            <div class="card mb-5">
                <div class="card-body p-sm-5">
                    <h2 class="text-center mb-4">Choix matiere</h2><label class="form-label"><span style="color: rgb(3, 114, 225);">Matiere:&nbsp;</span></label><select style="width: 205px;">
                        <optgroup label="Liste look">
                            <option value="1">cuire</option>
                            <option value="2">raphia</option>
                            <option value="3">daim</option>
                        </optgroup>
                    </select>
                    <form method="post">
                        <div class="mb-3"></div>
                        <div class="mb-3"></div>
                        <div class="mb-3"></div>
                        <div><button class="btn btn-warning d-block w-100" type="submit" style="background: rgb(101,160,160);">Consulter formule</button></div>
                    </form>
                </div>
            </div>
        </div>

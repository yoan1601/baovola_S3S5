...
<body>
    <form style="max-width: 700px;margin: 70px;margin-left: 112px;" role="form" action="NewTypeEmploye" method="post">
        <div class="form-group mb-3" style="font-size: 36px;text-align: center;color: rgb(177,28,19);"><label class="form-label" style="font-family: 'Abril Fatface', serif;font-weight: bold;text-decoration:  underline;"><span style="color: rgb(48, 47, 47);">Formulaire type employe:</span></label></div>
        <div class="form-group mb-3"><label class="form-label">Nom:</label><input class="form-control" type="text" id="tomSelect3" required="" name="nom" style="background: rgb(106,103,103);" placeholder="Veuiller inserer un nom"></div>
        <hr style="margin-top: 30px;margin-bottom: 10px;">
        <div class="form-group mb-3"><label class="form-label">Taux horaire:</label><input class="form-control" type="number" id="tomSelect3" required="" name="taux" style="background: rgb(106,103,103);" placeholder="Veuiller inserer un nombre"></div>
        <hr style="margin-top: 30px;margin-bottom: 10px;">
